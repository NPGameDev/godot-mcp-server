...
import type { ToolMeta, GroupResult } from "../registration/toolMeta.js"; // type-only: no circular runtime dep
  ...
  for (const cmd of group.commands) {
    ...
    registerToolWrapped(
      ...
      (input: unknown, signal?: AbortSignal) =>
        callAndWrap(bridge, cmd.method, input, { signal }) as Promise<import("../shared/types.js").ToolTextResult>,
    );
