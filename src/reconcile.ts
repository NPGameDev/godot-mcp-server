 ...
 *
 * Two entry points:
 *   - The debounced config_reloaded reload (re-read .mcp.json env → refresh mode →
 *     batched rebuild of the built-in surface → re-discover extensions).
...
export interface Reconciler {
  /** Re-read .mcp.json env → refresh mode → batched rebuild of the built-in surface → re-discover extensions.
