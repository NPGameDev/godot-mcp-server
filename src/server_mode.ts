 ...
 * module-allowed set (standard tools minus group-managed tools) is constant
 * across reloads (resolveAllowedTools() is the fixed STANDARD_TOOLS set;
 ...
 */
import { resolveAllowedTools } from "./profiles.js";
import { GROUP_TOOL_NAMES } from "./groups.js";

/** Standard tools minus group-managed tools — the set passed to registerBuiltinModules. Constant across reloads. */
