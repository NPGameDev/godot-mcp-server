...
export const STANDARD_TOOLS: readonly string[] = [
  ...
  "scene_create", "scene_instantiate", "scene_open", "scene_diff",
  // Node (4)
  "node_get_property", "node_set_property", "node_get_property_list", "node_set_script",
  // Script (4)
  "script_read", "script_write", "script_read_range", "script_delete",
  // Editor (8)
  "editor_get_errors", "editor_save_scene", "editor_screenshot",
  "editor_screenshot_node", "editor_reload_scripts", "editor_get_console",
  "editor_wait_for_idle", "project_get_settings",
  // Playtest (2)
...
export const MUTATING_TOOLS = new Set([
  // Scene mutations
  "scene_create_node", "scene_delete_node", "scene_create", "scene_delete",
  "scene_instantiate", "scene_close",
  // Node mutations
  "node_set_property", "node_set_script", "node_call_method",
  // Script mutations
  "script_write", "script_delete",
  // Editor mutations
  "editor_save_scene", "editor_reload_scripts",
  // Resource/folder/file
  "resource_write", "resource_delete", "folder_create", "folder_delete",
  "file_delete", "asset_import",
  // Playtest
  "game_start", "game_stop", "game_eval",
  // Settings
  "project_set_setting",
  // Signals
  "signal_manage", "signal_emit",
  // Input map
  "input_map_action", "input_map_event",
  // Animation / tilemap
  "animation_keyframe", "tilemap_set_cells",
  // User data
  "save_write", "save_delete",
  // Runtime
...
export function selectedProfile(): ProfileName {
  if (process.argv.includes("--lite")) {
    process.stderr.write(
      "[godot-mcp] Warning: --lite is deprecated. Use GODOT_MCP_PROFILE=minimal instead.\n",
    );
    return "minimal";
  }
