 ...
 *
 * Note: OS-symlink escapes are NOT here — symlink resolution is out of scope
 * on both sides (lexical canonicalization only; single-user localhost threat
 * model), so no fixture case can express one.
 * @internal
 */
